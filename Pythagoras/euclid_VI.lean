...
theorem proportional_iff_para {a b c d e: point} {L M N: line}
  ...
  have ead_eq_dae : area e a d = area d a e := by perm
  have ebd_eq_bde : area e b d = area b d e := by perm
  have dce_eq_cde : area d c e = area c d e := by perm
  ...
  have area_ead_neq_0 : area e a d ≠ 0 := by perm
